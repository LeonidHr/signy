    ...
    (() => {
        ...
        function formFieldsInit(options = {
            ...
            document.body.addEventListener("input", (e => {
                const targetElement = e.target;
                if (targetElement.hasAttribute("data-validate-now")) formValidate.validateInput(targetElement);
            }));
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if (formRequiredItem.dataset.required === "email") {
                    ...
                    if (this.emailTest(formRequiredItem)) {
                        ...
                        error++;
                        removeClass(formRequiredItem.parentElement, "_form-success");
                    } else {
                        this.removeError(formRequiredItem);
                        addClass(formRequiredItem.parentElement, "_form-success");
                    }
            ...
            formClean(form) {
                ...
                setTimeout((() => {
                    ...
                    for (let index = 0; index < inputs.length; index++) {
                        ...
                        removeClass(el.parentElement, "_form-success");
                    }
            ...
            formHidden(form) {
                if (form.hasAttribute("data-hidden-after-submit")) {
                    addClass(document.body, "form-success");
                    const emailValue = form.querySelector('[data-required="email"]').value;
                    console.log(emailValue);
                    document.querySelector("#input-email").innerHTML = emailValue;
                    setTimeout((() => {
                        removeClass(document.body, "form-success");
                    }), 5e3);
                }
            },
        ...
        document.querySelectorAll("form").forEach((form => {
            form.querySelectorAll("[data-disabled]").forEach((inpt => {
                inpt.addEventListener("input", (e => {
                    removeDisable(form);
                }));
            }));
        }));
        function removeDisable(form) {
            const inputs = form.querySelectorAll("[data-disabled]"), btn = form.querySelector("[data-disabled-btn]"), errorsArr = [];
            if (inputs.length) {
                inputs.forEach(((inp, i) => {
                    if (!inp.value) errorsArr.push(inp); else errorsArr.splice(i, 1);
                }));
                if (!errorsArr.length) removeClass(btn, "_disabled"); else addClass(btn, "_disabled");
            }
        }
        function formSubmit() {
            ...
            function formSent(form, responseResult = ``) {
                ...
                if (form.hasAttribute("data-popup-message")) showPopup(form, true);
                formValidate.formClean(form);
                removeDisable();
        ...
        function showPopup(form, isSucsess, response = "") {
            setTimeout((() => {
                if (modules_flsModules.popup) {
                    ...
                    if (isSucsess) popupTitle.insertAdjacentHTML("beforeend", `\n\t\t\t\t\t<h2 class="popup-form__title">${form.dataset.title}</h2>\n\t\t\t\t\t<p class="popup-form__text">\n\t\t\t\t\t\tТвое сообщение отправленно! Наши менеджеры свяжутся с тобой в ближайшее время\n\t\t\t\t\t</p>\n\t\t\t\t\t<div class="popup-form__img"><img class="img-fluid" src="img/popup/message.png" alt="Форма отправлена"></div>\n\t\t\t\t`); else popupTitle.insertAdjacentHTML("beforeend", `\n\t\t\t\t\t<h2 class="popup-form__title">Форма не отправлена!</h2>\n\t\t\t\t\t<p class="popup-form__text">\n\t\t\t\t\tОшибка ${response.status}.\n\t\t\t\t\t</p>\n\t\t\t\t`);
        ...
        class SelectConstructor {
            ...
            getSelectTitleValue(selectItem, originalSelect) {
                ...
                if (originalSelect.hasAttribute("data-search")) return `<div class="${this.selectClasses.classSelectTitle} _icon-arrow-down"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${selectTitleValue}" data-placeholder="${selectTitleValue}" class="${this.selectClasses.classSelectInput}"></span></div>`; else {
                    ...
                    if (this.getSelectedOptionsData(originalSelect).elements[0].dataset.link) return `<button type="button" class="${this.selectClasses.classSelectTitle} _icon-arrow-down"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}${pseudoAttributeClass}"><a href="${this.getSelectedOptionsData(originalSelect).elements[0].dataset.href}" class="${this.selectClasses.classSelectContent}${customClass}">${selectTitleValue}</a></span></button>`; else return `<button type="button" class="${this.selectClasses.classSelectTitle} _icon-arrow-down"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}${pseudoAttributeClass}"><span class="${this.selectClasses.classSelectContent}${customClass}">${selectTitleValue}</span></span></button>`;
                }
            }
        ...
        function initSliders() {
            if (document.querySelector(".main-slider__slider")) {
                const mainSlider = new core(".main-slider__slider", {
        ...
        document.addEventListener("DOMContentLoaded", (event => {
            function addDropdownHover() {
                ...
                document.querySelector("[data-dropdown-btn]");
            ...
            if (!isMobile.any()) addDropdownHover();
